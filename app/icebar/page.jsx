...
import Icebar from "../../public/icebar.png";

const PandaIcebarReceipt = () => {
            ...
            <div className="bg-white w-[360px] p-4 text-sm font-mono shadow-lg">
                ...
                <div className="text-center pb-2">
                    <Image
                        ...
                        priority
                    />
                    <p className="text-md pt-2">Panda Ice Bar</p>
                    <p className="text-md pt-2">8-C Commercial Area, Satellite Town</p>
                    <p className="text-md pt-2">Bahawalpur, Punjab 63100</p>
                    <p className="text-md pt-2">Phone: 062-2885522</p>
                </div>
...
export default PandaIcebarReceipt;
